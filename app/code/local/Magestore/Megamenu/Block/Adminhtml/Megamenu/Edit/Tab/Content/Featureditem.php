...
//        }
		...
		<script type="text/javascript">
                    function toggleFeaturedProducts(){
                        ...
                        var url = "' . $this->getUrl('adminhtml/megamenu/chooserFeaturedProducts') . '";
                    ...
                    function changeType(){
                        if($("featured_type").value == "3"){
                            ...
                            $("megamenu_featuredcategories").down("#featured_title").up().up().style.display = "none";
                            ...
                            $("megamenu_featuredcategories").down("#featured_title").up().up().style.display = "";
