...
class RichardMason_Profile_Model_Profile extends Mage_Core_Model_Abstract
{
	 ...
	 */
    const CATEGORY_CELEBS = 0;            // celebs
    const CATEGORY_PRINT = 1;    // print
    const CATEGORY_ONLINE = 2;    // online
    const CATEGORY_VIDEOS = 3;    // videos
    ...
    public function getThumbnailResize($with, $height = null) {
		...
		$imageUrl = $this->getData("thumbnail");
		
		return $imageUrl;
	
		// path of the resized image to be saved
		// here, the resized image is saved in media/resized folder
		$imageResized = "resized_".$this->getData("thumbnail"); 
		...
		return (Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB) . "resized_".$this->getData("thumbnail"));
    }
    ...
    public function getCategoryUrl($category_id)
    {
    	...
    	switch((int)$category_id){
    		case self::CATEGORY_CELEBS:
    			$url = "celebs";
    			break;
    		case self::CATEGORY_PRINT:
    			$url = "print";
    			break;
    		case self::CATEGORY_ONLINE:
    			$url = "online";
    			break;
    		case self::CATEGORY_VIDEOS:
    			$url = "videos";
    			break;
    	}
