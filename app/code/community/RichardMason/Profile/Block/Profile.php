...
class RichardMason_Profile_Block_Profile extends Mage_Core_Block_Template
{
    ...
    public function getCelebs(){
		return $this->getProfiles(RichardMason_Profile_Model_Profile::CATEGORY_CELEBS);
    }
    
    public function getPrint(){
		return $this->getProfiles(RichardMason_Profile_Model_Profile::CATEGORY_PRINT);
	}
	
    public function getVideos(){
		return $this->getProfiles(RichardMason_Profile_Model_Profile::CATEGORY_VIDEOS);
    }
    
    public function getOnline(){
		return $this->getProfiles(RichardMason_Profile_Model_Profile::CATEGORY_ONLINE);
    }
