...
class RichardMason_Profile_Adminhtml_ProfileController extends Mage_Adminhtml_Controller_action
{
	 ...
	 * News Index
	 */
	public function celebsAction(){
		Mage::register('profile_category_id', RichardMason_Profile_Model_Profile::CATEGORY_CELEBS);
		$this->_initAction()
			->renderLayout();
	}
	/*
	...
	public function printAction(){
		Mage::register('profile_category_id', RichardMason_Profile_Model_Profile::CATEGORY_PRINT);
		$this->_initAction()
			->renderLayout();
	}
	/*
	...
	public function onlineAction(){
		Mage::register('profile_category_id', RichardMason_Profile_Model_Profile::CATEGORY_ONLINE);
		$this->_initAction()
			->renderLayout();
	}	
	/*
	...
	public function videosAction(){
		Mage::register('profile_category_id', RichardMason_Profile_Model_Profile::CATEGORY_VIDEOS);
		$this->_initAction()
			->renderLayout();
	}
        ...
        if ($data = $this->getRequest()->getPost()) {
        	...
        	if(isset($_FILES['thumbnail']['name']) && $_FILES['thumbnail']['name'] != '') {
				try {	
					...
					$path = Mage::getBaseDir('media') . DS . "presspics" . DS ;
				...
				$data['thumbnail'] = "presspics/" . $_FILES['thumbnail']['name'];
			}
			else
			{
        	...
        	if(isset($_FILES['file']['name']) && $_FILES['file']['name'] != '') {
				try {	
	  			...
	  			$data['file'] = "presspics/" . $FILES['file']['name'];
			}
			else
			{
        	...
        	if(isset($_FILES['picture']['name']) && $_FILES['picture']['name'] != '') {
				try {	
	  			...
	  			$data['picture'] = "presspics/" . $_FILES['picture']['name'];
			}
			else
			{
