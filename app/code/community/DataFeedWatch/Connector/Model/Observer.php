    ...
    public function changeChildProductUpdatedAt(Varien_Event_Observer $observer)
    {
        ...
        if ($product->isConfigurable()) {
            ...
            foreach ($childProducts as $child) {
                //gets and leaves visibility of child products alone
                $childProduct = $child->load();
                $child->setUpdatedAt($product->getUpdatedAt())
                    ->setVisibility($childProduct->getVisibility())
                    ->save();
            }
        }
