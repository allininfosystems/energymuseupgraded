 ...
 */
class MageWorx_AbCart_Block_Adminhtml_Report_Storeview_Grid extends Mage_Adminhtml_Block_Report_Grid_Abstract
{
    ...
    protected function _toHtml()
    {
        ...
        if ($this->getCollection() && $this->getCollection()->getSize()) {
            $chart = $this->getLayout()->createBlock('mageworx_abcart/adminhtml_report_chart_storeview');
